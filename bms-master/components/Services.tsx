...
const services = [
    ...
    },
    {
        ...
        icon: <Wrench className="w-6 h-6 text-brand-highlight" />,
        items: [
        ...
        <Section id="services" darker>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {services.map((service, idx) => (
                    <div key={idx} className="bg-white shadow-lg border border-slate-200 rounded-2xl p-8 hover:border-brand-accent/30 transition-colors">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            {service.items.map((item, i) => (
                                <div key={i} className="space-y-2">
                                    <h4 className="text-brand-accent font-medium text-sm">{item.title}</h4>
